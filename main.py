...
async def on_ready() :
    ...
    await client.change_presence(status = discord.Status.idle, activity = discord.Activity(type=discord.ActivityType.listening, name="to ;help or @Gideon"))
...
league = {760426797418151937:847138145, #ag
  ...
  478610182625034243:207226768, #amit
